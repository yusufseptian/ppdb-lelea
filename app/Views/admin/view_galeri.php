            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label>Foto</label>
                            <input id="foto" type="file" accept="image/*" name="galeri_foto" class="form-control" onchange="bacaGambar(event)" required>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group" id="pre">
                                <label>Preview</label><br>
                                <img src="<?= base_url('foto_galeri/' . $value['galeri_foto']) ?>" id="gambar_load_edit" width="200px">
                            </div>
                        </div>
                    </div>
                </div>
